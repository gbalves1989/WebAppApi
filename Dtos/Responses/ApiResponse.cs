namespace WebAppApi.Dtos.Responses
{
    public class ApiResponse<T>
    {
        ...
        public static ApiResponse<T> Accept(T data, string message = "Atualizado com sucesso")
        {
            return new ApiResponse<T>(202, message, data);
        }

        public static ApiResponse<T> NoContent(T data, string message = "Removido com sucesso")
        {
            return new ApiResponse<T>(204, message, data);
        }
        ...
        public static ApiResponse<T> Conflict(string message = "Dado já cadastrado")
        {
            return new ApiResponse<T>(409, message);
        }
